"""
turbo_garbanzo component module.

This is the module of turbo_garbanzo containing DALiuGE data components.
...
# @param[in] param/appclass Drop Class/turbo_garbanzo.MyData/String/readonly/
