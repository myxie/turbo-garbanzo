"""
turbo_garbanzo appComponent module.

This is the module of turbo_garbanzo containing DALiuGE application components.
...
# @param[in] param/appclass Application Class/turbo_garbanzo.MyApp/String/readonly/
